...
const { createStandardAllocation, updateStandardAllocation, getAllStandardAllocations, getStandardAllocationById, deleteStandardAllocation, getSiteStandardAllocations } = require("../controllers/standardAllocation");
...
router.get("/houseschedule", getSiteStandardAllocations); // Public: Get all allocations
